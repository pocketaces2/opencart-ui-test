package com.opencart.bdd.runners;
...
@SelectClasspathResource("com/opencart/bdd/features/image_viewer.feature")
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.opencart.bdd.steps")
